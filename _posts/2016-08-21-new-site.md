...
<img src="../images/link-post-example.png" width="494px" alt="Screenshot that shows one red coloured title on a yellow background with anchor icon on the left." title="Link post title with an anchor." />
